...
namespace Celeste.Mod.XaphanHelper.Entities
{
    ...
    public class SaveStation : Solid
    {
        ...
        public override void Added(Scene scene)
        {
            base.Added(scene);
            level = SceneAs<Level>();
            level.Add(new Slope(Position, Vector2.UnitX, false, "Left", 7, 1, "Horizontal", "Horizontal", "cement", "cement", false, false, "", "", false, true, false, false, false, "", true));
            level.Add(new Slope(Position, new Vector2(-25f, 0f), false, "Right", 7, 1, "Horizontal", "Horizontal", "cement", "cement", false, false, "", "", false, true, false, false, false, "", true));
